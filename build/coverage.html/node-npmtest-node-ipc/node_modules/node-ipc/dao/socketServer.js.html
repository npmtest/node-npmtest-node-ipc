...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-node-ipc/node_modules/node-ipc/dao/socketServer.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-node-ipc">npmtest-node-ipc (v0.0.1)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-node-ipc/node_modules/node-ipc/dao/socketServer.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-node-ipc/node_modules/node-ipc/dao/</a> &#187; socketServer.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        eventParser=new EventParser(this.config);</span>
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >function startTLSServer(){</span>
<span class="cstat-no" title="statement not covered" >    this.log('starting TLS server',this.config.tls);</span>
<span class="cstat-no" title="statement not covered" >    if(this.config.tls.private){</span>
<span class="cstat-no" title="statement not covered" >        this.config.tls.key=fs.readFileSync(this.config.tls.private);</span>
    }else{
<span class="cstat-no" title="statement not covered" >        this.config.tls.key=fs.readFileSync(`${__dirname}/../local-node-ipc-certs/private/server.key`);</span>
    }
<span class="cstat-no" title="statement not covered" >    if(this.config.tls.public){</span>
<span class="cstat-no" title="statement not covered" >        this.config.tls.cert=fs.readFileSync(this.config.tls.public);</span>
    }else{
<span class="cstat-no" title="statement not covered" >        this.config.tls.cert=fs.readFileSync(`${__dirname}/../local-node-ipc-certs/server.pub`);</span>
    }
<span class="cstat-no" title="statement not covered" >    if(this.config.tls.dhparam){</span>
<span class="cstat-no" title="statement not covered" >        this.config.tls.dhparam=fs.readFileSync(this.config.tls.dhparam);</span>
    }
<span class="cstat-no" title="statement not covered" >    if(this.config.tls.trustedConnections){</span>
<span class="cstat-no" title="statement not covered" >        if(typeof this.config.tls.trustedConnections === 'string'){</span>
<span class="cstat-no" title="statement not covered" >            this.config.tls.trustedConnections=[this.config.tls.trustedConnections];</span>
        }
<span class="cstat-no" title="statement not covered" >        this.config.tls.ca=[];</span>
<span class="cstat-no" title="statement not covered" >        for(let i=0; i&lt;this.config.tls.trustedConnections.length; i++){</span>
<span class="cstat-no" title="statement not covered" >            this.config.tls.ca.push(</span>
                fs.readFileSync(this.config.tls.trustedConnections[i])
            );
        }
    }
<span class="cstat-no" title="statement not covered" >    this.server=tls.createServer(</span>
        this.config.tls,
        serverCreated.bind(this)
    );
}
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Mon Apr 17 2017 10:47:47 GMT+0000 (UTC)</div>
</div>
</body>
</html>
