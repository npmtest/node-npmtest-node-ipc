...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-node-ipc/node_modules/node-ipc/services/IPC.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-node-ipc/node_modules/node-ipc/services/IPC.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-node-ipc/node_modules/node-ipc/services/</a> &#187; IPC.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    if(this.config.silent){</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    const args=Array.prototype.slice.call(arguments);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for(let i=0, count=args.length; i&lt;count; i++){</span>
<span class="cstat-no" title="statement not covered" >        if(typeof args[i] != 'object'){</span>
<span class="cstat-no" title="statement not covered" >            continue;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        args[i]=util.inspect(</span>
            args[i],
            {
...
&nbsp;
<span class="fstat-no" title="function not covered" >function disconnect(id){</span>
<span class="cstat-no" title="statement not covered" >    if(!this.of[id]){</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.of[id].explicitlyDisconnected=true;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.of[id].off('*','*');</span>
<span class="cstat-no" title="statement not covered" >    if(this.of[id].socket){</span>
<span class="cstat-no" title="statement not covered" >        if(this.of[id].socket.destroy){</span>
<span class="cstat-no" title="statement not covered" >            this.of[id].socket.destroy();</span>
        }
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    delete this.of[id];</span>
}
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >function connect(id,path,callback){</span>
<span class="cstat-no" title="statement not covered" >    if(typeof path == 'function'){</span>
<span class="cstat-no" title="statement not covered" >        callback=path;</span>
<span class="cstat-no" title="statement not covered" >        path=false;</span>
    }
